...
from .public_api import (IssuerDidJson, IssuerBadgesJson, IssuerImage, BadgeClassJson,
...
json_patterns = [
    url(r'^issuers/(?P<entity_id>[^/.]+)/did$', xframe_options_exempt(IssuerDidJson.as_view(slugToEntityIdRedirect=True)), name='issuer_json'),
